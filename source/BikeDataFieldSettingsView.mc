...
class BikeDataFieldSettingsView extends WatchUi.View {
...
class BikeDataFieldSettingsDelegate extends WatchUi.BehaviorDelegate {
    ...
    public function onMenu() as Boolean {
        var menu = new $.BikeDataFieldSettingsMenu();
        ...
        WatchUi.pushView(menu, new $.BikeDataFieldSettingsMenuDelegate(), WatchUi.SLIDE_IMMEDIATE);
        return true;
    }
}
